...
🛠️ Tech StackPlataforma: Bubble.io.Banco de Dados: Modelagem Relacional e Option Sets.Integrações: API REST (Brasil API) via API Connector.
...
🚀 Funcionalidades PrincipaisMódulo Administrativo (Back-Office): Painel CRUD para gestão de médicos e monitoramento de consultas em tempo real utilizando Repeating Groups dinâmicos.
